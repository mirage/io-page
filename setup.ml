...
(* OASIS_START *)
(* DO NOT EDIT (digest: 31d7ade19b566e01f79965bc2b297830) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./portable.native", []))];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "io-page";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "io_page_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["stub_alloc_pages.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Io_page_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "io_page";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("bigarray", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["stub_alloc_pages_xen.c"];
                      bs_data_files = [];
                      bs_ccopt =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "io_page_unix";
                           InternalLibrary "io_page";
                           FindlibPackage ("oUnit", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["stub_get_addr.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "portable.ml"});
               Test
                 ({
                     cs_name = "portable";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "FV\179\192fS\1351\011\212\200\014\016\190\149\172";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
