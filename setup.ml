...
(* OASIS_START *)
(* DO NOT EDIT (digest: 36ce68081863981db4828d5947add45f) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "io-page"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "io-page";
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "\004Â\130ë\158@:U\142+PÝÙ\153GÆ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
