...
(* OASIS_START *)
(* DO NOT EDIT (digest: 68ff37df6fa1d0be0466ec540b81279c) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["stub_alloc_pages.c"; "stub_get_addr.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["stub_alloc_pages_xen.c"; "stub_get_addr_xen.c"];
                      bs_data_files = [];
                      bs_findlib_extra_files = [];
                      bs_ccopt =
     ...
     oasis_digest = Some "\195\b\255g\246bA\2020%\180?\178S\130\157";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
